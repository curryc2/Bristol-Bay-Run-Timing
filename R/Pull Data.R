...
# July_dat <- filter(Airport_dat, MONTH==6)
...
Model_dat <- full_join(Model_dat, ChlA_meantiming_GOA, by= "YEAR")
Model_dat <- full_join(Model_dat, ChlA_meanmagnitude_GOA, by= "YEAR")
