...
lm_variables<- list(
  Ege  = c("S_June_cumnorthwind","S_ChlA_GOAmagnitude","S_extent"),
  Kvi  = c("S_PDO_May","S_ENSO_May","S_ChlA_GOAmagnitude","S_ChlA_GOAtiming","S_extent"),
  Nush = c("S_extent","S_June_Temp","S_Abundance"),
  Tog  = c("S_June_cumeastwind","S_PDO_May","S_ChlA_GOAmagnitude","S_extent","S_Togiak_meanflow_June"),
  Uga  = c("S_PDO_May","S_ChlA_GOAmagnitude","S_extent","S_ENSO_May")
) 
