...
model_bestu <- lm(Uga ~ S_PDO_May + S_ChlA_GOAmagnitude + S_June_pressure + S_extent + S_GOA_SpringSST + S_Ugashik_meanflow_June + S_Uga_JuneSST,
...
model_beste <- lm(Ege ~ S_June_cumeastwind + S_June_cumnorthwind + S_PDO_May + S_ChlA_GOAmagnitude + S_June_pressure + 
                    S_extent + S_Abundance + S_GOA_SpringSST + S_Egegik_meanflow_June +  S_Ege_JuneSST,
...
model_bestk <- lm(Kvi ~ S_Kvi_lag1 + S_PDO_May + S_ENSO_May + S_ChlA_GOAmagnitude + S_ChlA_GOAtiming +
                    S_extent + S_GOA_SpringSST + S_KvichakDistrict_meanflow_June + S_Kvichakproportion + S_Kvi_JuneSST, 
...
model_beste_2000 <- lm(Ege ~ S_PDO_May + S_ENSO_May + S_extent,
...
model_bestk_2000 <- lm(Kvi ~ S_PDO_May + S_ENSO_May + S_extent, 
...
model_bestt_2000 <- lm(Tog ~ S_June_temp + S_June_cumnorthwind + S_PDO_May + S_June_pressure + S_extent + S_Tog_JuneSST, 
...
#     )
# 
#     fit <- lm(formula, data = S_Model_dat_Uga_noChlA2000, na.action = na.omit)
# 
...
#     )
#     
#     fit <- lm(formula, data = S_Model_dat_Ege_noChlA2000, na.action = na.omit)
#     
#     results <- rbind(results, data.frame(
#       model = deparse(formula),
#       AIC = AIC(fit),
...
#     )
#     
#     fit <- lm(formula, data = S_Model_dat_Kvi_noChlA2000, na.action = na.omit)
#     
#     results <- rbind(results, data.frame(
#       model = deparse(formula),
#       AIC = AIC(fit),
...
#     )
#     
#     fit <- lm(formula, data = S_Model_dat_Nush_noChlA2000, na.action = na.omit)
#     
#     results <- rbind(results, data.frame(
#       model = deparse(formula),
#       AIC = AIC(fit),
...
#     )
#     
#     fit <- lm(formula, data = S_Model_dat_Tog_noChlA2000, na.action = na.omit)
#     
#     results <- rbind(results, data.frame(
#       model = deparse(formula),
#       AIC = AIC(fit),
